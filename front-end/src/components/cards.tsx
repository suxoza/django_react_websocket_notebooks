        ...
        <div className="block rounded-lg bg-white text-center dark:bg-neutral-700 w-56 border-gray-300 border hover:shadow-xl">
            ...
            <div className="p-6">
                ...
                <div className="w-full justify-center items-center gap-x-2 flex">
                    <button onClick={() => navigate(`/doc/${props.note?.id}/edit`, {state: props.note})} type="button" className="w-1/2 inline-block text-black rounded-lg bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal border border-gray-500 hover:shadow-xl hover:text-green-800">
                        Edit
                    </button>
                    <button onClick={() => navigate(`/doc/${props.note?.id}/view`, {state: props.note})} type="button" className="w-1/2 inline-block text-black rounded-lg bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal border border-gray-500 hover:shadow-xl hover:text-green-800">
                        View
                    </button>
                </div>
            </div>
